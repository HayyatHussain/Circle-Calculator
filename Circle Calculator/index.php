...
<body>
    ...
    <form action="index.php" method="post">
        ...
        <input type="number" name="radius" id="war" required placeholder="0"><br><br>
        <input type="submit" value="Submit" id="btn"><br><br>
    </form>

    <div id="circle"></div><br><br>
    <p>Radius is too big. Anything greater than 299px is not supported, and a circle of width/height = 200px is sketched. If allowed, that would be one thicc circle!!!!</p>
